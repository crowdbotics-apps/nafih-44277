"""
Django settings for nafih_44277 project.
...
WSGI_APPLICATION = 'nafih_44277.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "nafih_44277 API",
    "DESCRIPTION": "API documentation for nafih_44277 App",
    "VERSION": "v1",
}
